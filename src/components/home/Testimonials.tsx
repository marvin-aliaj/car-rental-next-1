  ...
  const sampleTestimonials = [
    {
      id: 1,
      rating: 5,
      comment: "The service was exceptional! The car was clean, well-maintained, and the pickup process was smooth. I will definitely be renting from AutoRental again.",
      user: {
        id: 1,
    ...
    },
    {
      id: 2,
      rating: 4,
      comment: "Great selection of vehicles at reasonable prices. The BMW I rented was in perfect condition and made my business trip much more enjoyable. Highly recommend!",
      user: {
        id: 2,
    ...
    },
    {
      id: 3,
      rating: 5,
      comment: "The app made booking so easy! I was able to select my car, pay, and arrange pickup all within minutes. The staff was friendly and helpful. Will use again!",
      user: {
        id: 3,
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-neutral-800">What Our Customers Say</h2>
